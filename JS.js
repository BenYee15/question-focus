...
// Add mousedown event listener on window to handle clicks outside the menu
  ...
  setFocusToMenuitem(newMenuitem) {
    this.menuitemNodes.forEach(function (item) {
      item.tabIndex = -1;   // sets all menu items to tabIndex -1
    });
    newMenuitem.tabIndex = 0; // sets the focused menu item to tabIndex 0
    newMenuitem.focus(); // sets focus to the focused menu item
  }
